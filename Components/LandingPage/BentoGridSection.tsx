...
export default function BentoGridSection() {
  return (
    <section className="py-32 px-6 md:px-12 max-w-[1600px] mx-auto z-10 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 h-[800px]">
        <div className="reveal-up md:col-span-2 md:row-span-2 relative group rounded-[30px] overflow-hidden cursor-pointer">
          <div className="absolute inset-0 bg-gradient-to-br from-[#00d4b6]/20 to-transparent z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        ...
        <div className="reveal-up md:col-span-2 relative group rounded-[30px] overflow-hidden cursor-pointer">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-purple-900/60 to-black/60 group-hover:from-purple-900/40 transition-colors"></div>
        ...
        <div className="reveal-up relative group rounded-[30px] overflow-hidden cursor-pointer bg-gradient-to-br from-[#111] to-[#1a1a1a]">
        ...
        <div className="reveal-up relative group rounded-[30px] overflow-hidden cursor-pointer bg-gradient-to-br from-[#00d4b6] to-[#00a896] p-8 flex flex-col justify-between">
