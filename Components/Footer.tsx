...
interface FooterSectionProps {
  goalSectionRef: React.RefObject<HTMLElement>;
}
...
export default function FooterSection({ goalSectionRef }: FooterSectionProps) {
  return (
    <section
      ref={goalSectionRef}
      className="relative min-h-screen flex flex-col items-center justify-end pb-16 bg-gradient-to-b from-[#050505] via-[#0a0a0a] to-[#111] overflow-hidden"
    >
      {/* Background mega text */}
      <div className="absolute top-1/4 w-full text-center z-0 pointer-events-none select-none">
        <h2 className="text-[13vw] font-black uppercase tracking-tighter text-white/[0.025] leading-none">
          MDFLD<br/>SYNDICATE
        </h2>
      </div>
      ...
      <div className="relative w-[90%] max-w-[580px] h-[240px] md:w-[520px] md:h-[300px] z-40 mt-auto mb-12">
        ...
        <div className="relative w-full h-full border-t-[14px] border-l-[14px] border-r-[14px] border-white rounded-t-2xl flex items-end justify-center shadow-[0_-20px_80px_rgba(0,212,182,0.15),0_0_0_1px_rgba(255,255,255,0.05)] overflow-hidden">
          ...
          {/* Post glow accents */}
          <div className="absolute left-0 top-0 bottom-0 w-6 bg-gradient-to-r from-[#00d4b6]/10 to-transparent"></div>
          <div className="absolute right-0 top-0 bottom-0 w-6 bg-gradient-to-l from-[#00d4b6]/10 to-transparent"></div>
          <div className="absolute top-0 left-0 right-0 h-6 bg-gradient-to-b from-[#00d4b6]/10 to-transparent"></div>
        </div>
